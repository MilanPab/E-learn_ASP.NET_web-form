                    ...
                    <div class="main_blog_post_content">
                        <div class="row">
                            <div class="col-sm-6 col-lg-6 col-xl-6">
                                <div class="blog_grid_post mb30">
                                    ...
                                    <div onclick="div1_clicked" class="details">
                                        <h3><a href="NewsDetail.aspx">Learning, Friendship and Fun</a></h3>
                                        <ul class="post_meta">
                            ...
                            <div class="col-sm-6 col-lg-6 col-xl-6">
                                <div class="blog_grid_post mb30">
                                    <div class="thumb">
                                        <img class="img-fluid" src="images/blog/bg3.jpg" alt="bg3.jpg">
                                        <div class="tag">Marketing</div>
                                        <div class="post_date">
                                            <h2>28</h2>
                                            <span>DECEMBER</span></div>
                            ...
                            <div class="col-sm-6 col-lg-6 col-xl-6">
                                <div class="blog_grid_post mb30">
                                    <div class="thumb">
                                        <img class="img-fluid" src="images/blog/bg4.jpg" alt="bg4.jpg">
                                        <div class="tag">Marketing</div>
                                        <div class="post_date">
                                            <h2>28</h2>
                                            <span>DECEMBER</span></div>
                    ...
                    <div class="main_blog_post_widget_list">
                        ...
                        <div class="blog_category_widget">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">Admissions <span class="float-right">6</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">News <span class="float-right">1</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">Event <span class="float-right">6</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">Focus in the lab <span class="float-right">16</span>
                                </li>
                            </ul>
                        </div>
