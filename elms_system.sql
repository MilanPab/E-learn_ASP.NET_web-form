...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2023 at 03:23 AM
...
(2, 'DBMS', 'This is dbms', 'https://www.youtube.com/results?search_query=asp.net', 'images/Courses/c83dd16d-1dd6-424e-b9fc-a6caaa7a03f4.png', 'Available', '2023-01-12 23:00:01'),
(3, 'Python Full Course', 'It is Python Course', 'https://www.youtube.com/watch?v=T936yTchDck', 'images/Courses/31b7be31-0345-44f6-bc07-be394ed17a33.png', 'Not Availab', '2023-01-13 10:58:13'),
(4, 'Java', 'This is Java', 'https://www.youtube.com/watch?v=T936yTchDck', 'images/Courses/f66f3f90-7af6-4f1b-a64f-2ce9813a63f5.png', 'Available', '2023-01-14 23:43:43');
...
INSERT INTO `news` (`id`, `news_title`, `news_des`) VALUES
...
(2, 'India 2023 Budget Launch', 'The Department of Education, Sport and Culture (DESC) has launched a consultation on a new uniform policy for the island secondary schools.Currently each sets their own rules under guidance from the department.DESC Minister Julie Edge said the review was '),
...
(4, 'The Next PM of United Kingdom', 'An investigation into whether creating new sports hubs would ensure the future of the Isle of Man regional swimming pools has been backed by Tynwald.The Department of Education, Sport and Culture  had proposed controlling the struggling pools centrally.Bu');
...
ALTER TABLE `enrolled_courses`
  ...
  ADD CONSTRAINT `Student` FOREIGN KEY (`student_id`) REFERENCES `students` (`st_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
